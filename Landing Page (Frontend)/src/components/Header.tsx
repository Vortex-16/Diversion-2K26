        ...
        <header className="fixed top-0 left-0 right-0 z-50 flex justify-center pointer-events-none pt-5">
            ...
            >
                <div className="navbar-glass flex items-center gap-2 px-4 py-2.5 rounded-full">
                    {/* Logo */}
                    <Link to="/" className="flex items-center gap-2.5 px-3 py-1.5 rounded-full hover:bg-white/10 transition-all duration-300">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        >
                            <i className={`fas ${darkMode ? 'fa-sun text-amber-400' : 'fa-moon text-slate-500'} text-sm`} />
                        </motion.button>
                        ...
                        >
                            <i className={`fas ${mobileOpen ? 'fa-times' : 'fa-bars'} text-sm`} style={{ color: 'var(--text-secondary)' }} />
                        </button>

                        {/* Login Button */}
                        <Link to="/sign-in" className="nav-cta flex items-center gap-2 shrink-0">
